...
你是一名资深高中数学教研专家兼知识图谱工程师。请从给定的高中数学试卷 Markdown 文本中抽取试卷、题目信息，并为每道题从知识图谱清单中选择考查的四级知识点。

## 四级知识点清单（只能从中选择，不要自编名称）
以下清单中的知识点已经存在于知识图谱中。你必须**严格从该清单中选择**最匹配的知识点名称填入 candidate_knowledge_points，不要自己编造或近似命名。
  ...
  "questions": [
    {
      ...
      "score": 5,
      "question_type": "单选题",
      "candidate_knowledge_points": ["知识点名称1", "知识点名称2"],
...
## 约束
1. **candidate_knowledge_points 必须严格从「四级知识点清单」中选取，名称要一字不差**。每道题列 1-5 个最相关的四级知识点。若某题确实无法匹配清单中任何知识点，填空数组 `[]`。
